...
public class ClassRoom {
  ...
  public static void main(String[] args) {
    ...
    trainer.addClassRoomListener(student1);
    trainer.addClassRoomListener(student2);
    trainer.addClassRoomListener(student3);
    trainer.addClassRoomListener(student4);
    trainer.addClassRoomListener(student5);
    trainer.addClassRoomListener(student6);

    //fire an event by invoking the 'saysStartExercise(int exerciseNumber)' method on the trainer object
    trainer.saysStartExercise(1);

    //Un-register two listeners
    trainer.removeClassRoomListener(student1);
    trainer.removeClassRoomListener(student2);

    //once again, fire a ClassRoomEvent
    trainer.saysStartExercise(2);
  }
}