...
public abstract class Student extends Person implements ClassRoomListener {
  ...
  public void startExercise(ClassRoomEvent cre) {
    System.out.println(this.getFirstName() + " " + this.getLastName() + " : " + getStartExercisePhrase() + " " + cre.getExerciseNo());
  }
