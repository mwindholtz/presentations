...
public class ItalianStudent extends Student {
  private String startExercisePhrase = "Comincio con esercizio";

  public ItalianStudent(String firstName, String lastName) {
